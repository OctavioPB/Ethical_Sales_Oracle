...
import type { CallScore, InterventionEvent } from "@/types";
...
export function CallDetailPage({ callId, onBack }: CallDetailPageProps) {
  ...
  const allInterventions = [
    ...
    ...localInterventions.filter(
      (li) => !detail?.interventions.some((di) => di.id === li.id),
    ),
  ];
  ...
  return (
    <main id="main-content">
        ...
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              >
                Call{" "}
                <em style={{ fontStyle: "italic", color: "var(--gold-light)", fontFamily: "Courier New, monospace", fontSize: 22 }}>
                  …{shortId}
                </em>
              </h1>
      ...
      {error && (
        <div
          role="alert"
          style={{ padding: "48px", maxWidth: 1300, margin: "0 auto" }}
        >
          <p
            style={{
              fontFamily: "var(--fb)",
      ...
      >
        <span>ESO · Ethical Sales Oracle · Call Detail</span>
        <span>
          {new Date()
