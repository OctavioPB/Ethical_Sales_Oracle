...
function LoginScreen() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Top accent */}
        <div style={{ height: 3, backgroundColor: "var(--gold)", borderRadius: "2px 2px 0 0", margin: "-48px -56px 36px" }} />
        ...
        >
          Ethical Sales{" "}
          <em style={{ fontStyle: "italic" }}>Oracle</em>
        </h1>
        <p
          style={{
            fontFamily: "var(--fb)",
...
function AuthenticatedApp() {
  ...
  return (
    <>
      ...
      <Nav
        currentPage={page}
        onNavigate={(p) => { setPage(p); setSelectedCallId(null); }}
